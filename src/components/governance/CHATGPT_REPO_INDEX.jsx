...
export const CHATGPT_REPO_INDEX = {
  ...
  readThisFirst: {
    governanceVerification: [
      ...
      { step: 8, label: "Workstream Registry",    path: "src/components/projects/WORKSTREAM_REGISTRY.jsx",      reason: "All active and planned internal workstreams.",             rawUrl: `${RAW}/src/components/projects/WORKSTREAM_REGISTRY.jsx`,      githubUrl: `${GH}/src/components/projects/WORKSTREAM_REGISTRY.jsx`,      exists: true },
    ],
    routingVerification: [
    ...
    projectStructureVerification: [
      { step: 1, label: "Workstream Registry", path: "src/components/projects/WORKSTREAM_REGISTRY.jsx", reason: "Source of truth for all internal workstreams.",  rawUrl: `${RAW}/src/components/projects/WORKSTREAM_REGISTRY.jsx`, githubUrl: `${GH}/src/components/projects/WORKSTREAM_REGISTRY.jsx`, exists: true },
      { step: 2, label: "Projects Page",    path: "src/pages/Projects.jsx",                          reason: "Verify it reads from WORKSTREAM_REGISTRY.",   rawUrl: `${RAW}/src/pages/Projects.jsx`,                          githubUrl: `${GH}/src/pages/Projects.jsx`,                          exists: true },
