export const PHASE_EXECUTION_LOG = {
  ...
  // RESET EXECUTED 2026-03-17 under gov-006 authorization.
  // All pre-reset development-phase entries have been moved to
  // logLifecycleModel.devPhaseArchive below. No data has been discarded.
  entries: [],
  ...
  logLifecycleModel: {
    ...
    // 1. devPhaseArchive
    // READ-ONLY historical archive of entries produced during the development phase.
    // Populated by the one-time controlled reset executed on 2026-03-17 under gov-006.
    // These entries were the full contents of PHASE_EXECUTION_LOG.entries before the reset.
    // No data has been discarded. No entries have been silently removed.
    devPhaseArchive: {
      description: 'Read-only historical archive of entries produced during the development phase (pre-reset).',
      sourceEntries: 'PHASE_EXECUTION_LOG.entries captured at the time of the governed reset — 2026-03-17',
      nonRuntime: true,
      readOnly: true,
    ...
    // 3. resetOperation — EXECUTED 2026-03-17 under gov-006 authorization
    // The one-time controlled reset described here has been performed.
    // Pre-reset entries are preserved in devPhaseArchive.archivedEntries above.
    // PHASE_EXECUTION_LOG.entries is now [] (clean active runtime list).
    resetOperation: {
      specOnly: false,
      ...
      notExecuted: false,
      executedAt: '2026-03-17',
      note: 'Reset executed. All 17 pre-reset development-phase entries are preserved in ' +
            'devPhaseArchive.archivedEntries. No data was discarded. ' +
            'PHASE_EXECUTION_LOG.entries is now the clean active runtime list.',
    },
