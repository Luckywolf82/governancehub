...
const MANIFEST = {
  ...
  files: [
    ...
    { path: "src/components/projects/PROJECT_REGISTRY.jsx", fileName: "PROJECT_REGISTRY.jsx", extension: "jsx", folder: "src/components/projects", rawUrl: `${RAW_BASE}/src/components/projects/PROJECT_REGISTRY.jsx`, githubUrl: `${GH_BASE}/src/components/projects/PROJECT_REGISTRY.jsx`, category: "projects", exists: true },
  ],
};
...
const PRIORITY = {
  files: [
    ...
    { path: "src/components/projects/PROJECT_REGISTRY.jsx", label: "Project Registry", priority: "high", whyItMatters: "Canonical registry of all GovernanceHub projects.", rawUrl: `${RAW_BASE}/src/components/projects/PROJECT_REGISTRY.jsx`, githubUrl: `${GH_BASE}/src/components/projects/PROJECT_REGISTRY.jsx`, lockedFile: false, exists: true },
